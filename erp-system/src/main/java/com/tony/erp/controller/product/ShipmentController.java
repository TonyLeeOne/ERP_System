...
public class ShipmentController {
    ...
    public String getAll(ModelMap modelMap) {
        modelMap.addAttribute("ships", shipmentService.getAllShips(1,null));
    ...
    public String getAll(@PathVariable int pageNum,
        ...
        param.put("sShipDate", sShipDate);
        param.put("sProCode", sProCode);
        param.put("sOrderNo", sOrderNo);
        param.put("sStatus", sStatus);
        modelMap.addAttribute("ship", param);
        modelMap.addAttribute("page", shipmentService.getAllShips(pageNum, param));
        return "/shipment/list";
    }
