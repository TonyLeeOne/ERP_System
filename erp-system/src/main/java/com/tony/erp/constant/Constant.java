...
public class Constant {
     ...
     * 处理结果集
     */
    public static final String DATA_ADD_SUCCESS="新增数据成功";
    public static final String DATA_ADD_FAILED="新增数据失败";
    public static final String DATA_UPDATE_SUCCESS="数据更新成功";
    public static final String DATA_UPDATE_FAILED="数据更新失败";
    public static final String DATA_UDELETE_SUCCESS="删除数据成功";
    public static final String DATA_DELETE_FAILED="删除数据失败";
    public static final String ARG_EXCEPTION="参数不允许为空";
    public static final String RESPONSE_SUCCESS="请求成功";
    public static final String RESPONSE_FAILED="请求失败";
    public static final String CHECK_INFO="当前角色因用户占用，不可删除";
    public static final String ACOUNT_LOCAKED="你的账号已被锁定，请10分钟后重试！";
    public static final String LOGIN_SUCCESS="登陆成功";
    public static final String UNAME_EXISTS="当前用户用户名已被占用";
