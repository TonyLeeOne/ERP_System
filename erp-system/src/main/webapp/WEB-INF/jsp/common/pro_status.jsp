...
<jsp:useBean id='map5' class='java.util.HashMap' scope='session'>
    ...
    <c:set target='${map5}' property='1' value='量产中'/>
    <c:set target='${map5}' property='2' value='已停产'/>
</jsp:useBean>
<c:out value="${map5[product.proStatus]}"/>
